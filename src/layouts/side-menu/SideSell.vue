        ...
        <ul>
          ...
          <!-- <li>
            <SideMenuTooltip
              ...
              :content="`ออกจากระบบ`"
              @click="onclickLogout"
              class="w-full side-menu bg-theme-6">
              <div class="side-menu__icon">
                <LockIcon />
              </div>
...
import MobileMenu from '@/components/mobile-menu/MobileSell.vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    const sideMenu = computed(() => nestedMenu(store.state.sideMenuSell.menu, route))
