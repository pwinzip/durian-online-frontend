    ...
    <nav class="container flex flex-wrap items-center px-4 mx-auto leading-normal tracking-normal">
      ...
      <div class="hidden w-full ml-auto text-white lg:block lg:w-auto">
        ...
        <div class="inline-block px-4 py-2">
          <router-link to="/register" class="inline-block px-8 py-4 mx-auto mt-4 font-bold text-gray-800 transition duration-300 ease-in-out transform bg-white rounded-full shadow opacity-75 lg:mx-0 hover:no-underline lg:mt-0 focus:outline-none focus:shadow-outline hover:scale-105">ลงทะเบียนผู้ใช้งาน</router-link>
        </div>
      </div>
