    ...
    <div class="container px-8 mx-auto">
      <div class="flex flex-col w-full py-6 md:flex-row">
        <div class="flex-1 mb-6 text-black">
          <router-link
            to="/"
            class="text-2xl font-bold text-pink-600 no-underline hover:no-underline lg:text-4xl">
            <img :src="require('@/assets/images/durian-logo.svg')" class="inline h-12 fill-current" />
            Durian Online
          </router-link>
        ...
        <div class="flex-1">
          ...
          <ul class="mb-6 list-reset">
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <router-link to="/login" class="text-gray-800 no-underline hover:underline hover:text-pink-500"
            ...
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <router-link
                to="/register"
                class="text-gray-800 no-underline hover:underline hover:text-pink-500"
        ...
        <div class="flex-1">
          ...
          <ul class="mb-6 list-reset">
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
              <a href="#" class="text-gray-800 no-underline hover:underline hover:text-pink-500"
                >Official Blog</a
              >
            </li>
            <li class="inline-block mt-2 mr-2 md:block md:mr-0">
