    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="mt-5 intro-y box lg:mt-0">
          ...
          <div v-for="value in inProgress" :key="value.id" class="p-5">
            <div class="relative flex items-center">
              <div class="w-24 mr-auto">
                <div class="font-medium">{{ value.genes.gene }}</div>
                <div class="text-gray-600">{{ value.torns.torn_name }}</div>
              </div>
              <div class="ml-1 text-gray-900">{{ value.grades.grade }}</div>
              <div class="ml-2 font-medium text-center text-gray-900">{{ value.offer_amount }} kg</div>
              <div class="ml-2 text-center text-gray-900">{{ value.offer_price }} ฿</div>
              <div class="ml-2 text-center text-gray-900">
      ...
      <div class="col-span-12 lg:col-start-4 2xl:col-span-4">
        <div class="mt-5 intro-y box lg:mt-0">
          <div class="relative flex items-center p-5 border-b border-gray-200">
            <div class="ml-4 mr-auto">
              <div class="font-medium text-theme-1">กำลังคัดทุเรียน</div>
            </div>
          </div>
          <!-- show offer status list -->
        ...
        <div class="mt-5 intro-y box lg:mt-0">
          ...
          <div v-for="value in completed" :key="value.id" class="p-5">
            <div class="relative flex items-center">
              ...
              <div class="ml-auto mr-5 text-gray-900 align-middle">{{ value.grades.grade }}</div>
              <div class="ml-auto mr-5 font-medium text-gray-900">{{ value.offer_amount }} kg</div>
              <div class="ml-auto">
                <div class="text-gray-600">{{ value.offer_price }} ฿</div>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    ...
    http.get('user-offer-buy/' + userid).then(res => {
