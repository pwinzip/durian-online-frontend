  ...
  <div class="home">
    <div class="container flex flex-col flex-wrap items-center px-3 mx-auto text-white md:flex-row">
      ...
      <div class="flex flex-col items-start justify-center w-full text-center md:w-2/5 md:text-left">
        <p class="w-full uppercase tracking-loose">Farm to Future Business</p>
      ...
      <div class="w-full py-6 text-center md:w-3/5">
        <img class="z-50 w-3/5 md:w-3/5" :src="require(`@/assets/images/durian-logo.png`)" />
      </div>
    </div>
