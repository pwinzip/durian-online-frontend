<template>
  <div class=" home">
    <div class="container flex flex-col flex-wrap items-center px-3 mx-auto text-white md:flex-row">
        <!--Left Col-->
        <div class="flex flex-col items-start justify-center w-full text-center md:w-2/5 md:text-left">
          <p class="w-full uppercase tracking-loose">Farm to Customer</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Hub of Durian Online Martket Platform
          </h1>
          <p class="mb-8 text-2xl leading-normal">
            Next Generation of Selling Durian in Digital Platform
          </p>
        ...
        <div class="w-full py-6 text-center md:w-3/5">
          <img class="z-50 w-full md:w-4/5" src="@/assets/images/hero.png" />
        </div>
    </div>
